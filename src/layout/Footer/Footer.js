...
export const Footer = () => {
    return(
        <Container>
                <Content>
                    <a href='https://github.com/nangonz' target='_blank' rel="noreferrer"><GithubIcon/></a>
                    <a href='https://www.linkedin.com/in/dami-gonzalez' target='_blank' rel="noreferrer"><LinkedinIcon/></a>
                    <span>Copyright © Damian Gonzalez</span>
                </Content>
        </Container>
    );
};